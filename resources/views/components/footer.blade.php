<footer class="bg-instansi-primary text-white relative overflow-hidden">
    ...
    <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-yellow-400/20 via-yellow-400/50 to-yellow-400/20"></div>
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between gap-12 lg:gap-8">
            ...
            <div class="flex flex-col space-y-6 lg:max-w-[320px] xl:max-w-[380px]">
                ...
                <div class="flex items-center space-x-4 mb-2">
                    ...
                    <div>
                        <h3 class="font-extrabold text-xl leading-tight text-white tracking-wide">BAPPELITBANGDA</h3>
                        <p class="text-[13px] font-medium text-yellow-400 tracking-widest uppercase">Kab MAHULU</p>
                    </div>
                </div>
                ...
                <ul class="space-y-4 text-sm text-slate-300 max-w-xs">
                    <li class="flex items-start space-x-3 group">
                        <div class="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center flex-shrink-0 group-hover:bg-yellow-400/20 transition-colors border border-white/5">
            ...
            <div class="lg:w-auto">
                <h4 class="font-bold text-white mb-6 uppercase tracking-wider text-sm flex items-center">
                    <span class="w-2 h-2 rounded-full bg-yellow-400 mr-3"></span>
                    Link Terkait
                </h4>
                <ul class="space-y-3 text-[13px] text-slate-300 font-medium tracking-wide">
                    ...
                    <li>
                        <a href="{{ $link['url'] }}" target="_blank" class="hover:text-yellow-400 flex items-center group transition-all duration-300 hover:translate-x-1">
                            <span class="text-white/30 mr-2 group-hover:text-yellow-400 transition-colors">-</span> {{ $link['label'] }}
                        </a>
                    </li>
                    @endforeach
                </ul>
            ...
            <div class="lg:w-auto">
                ...
                <ul class="space-y-2 text-[13px] text-slate-300 font-medium tracking-wide mb-8">
                    ...
                    <li>
                        <a href="{{ $kota['url'] }}" target="_blank" class="hover:text-yellow-400 flex items-center group transition-all duration-300 hover:translate-x-1">
                            <span class="text-white/30 mr-2 group-hover:text-yellow-400 transition-colors">-</span> {{ $kota['label'] }}
                        </a>
                    </li>
                    @endforeach
                </ul>
                ...
                <div class="grid grid-cols-1 gap-2 text-[13px] text-slate-300 font-medium tracking-wide">
                    ...
                    @foreach($bappedaKab as $kab)
                        <a href="{{ $kab['url'] }}" target="_blank" class="hover:text-yellow-400 flex items-center group transition-all duration-300 hover:translate-x-1">
                            <span class="text-white/30 mr-2 group-hover:text-yellow-400 transition-colors">-</span> {{ $kab['label'] }}
                        </a>
                    @endforeach
                </div>
            </div>
    ...
    <div class="bg-instansi-primary border-t border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex items-center justify-center">
            <p class="text-[13px] text-slate-500 tracking-wider">
                <span class="text-white/60">About Developer</span> - <span class="text-white font-medium hover:text-yellow-400 cursor-pointer transition-colors">AK Kreatif</span>
            </p>
        </div>
    </div>
</footer>
