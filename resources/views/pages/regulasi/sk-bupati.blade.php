<x-layouts.app>
    <section class="relative pt-[100px] pb-20 overflow-hidden bg-slate-900">
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <svg class="absolute inset-0 w-full h-full" viewBox="0 0 1440 400" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="rgSKB" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#FBBF24" stop-opacity="0"/><stop offset="30%" stop-color="#FBBF24" stop-opacity="0.2"/><stop offset="100%" stop-color="#FBBF24" stop-opacity="0"/></linearGradient></defs><path d="M-50,180 C200,120 400,240 720,160 S1100,80 1500,200" fill="none" stroke="url(#rgSKB)" stroke-width="2"/></svg>
        </div>
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
            <div class="max-w-4xl mx-auto text-center" data-aos="fade-up">
                ...
                <h1 class="font-montserrat font-black text-4xl sm:text-5xl lg:text-6xl text-white leading-tight drop-shadow-2xl">SK <span class="text-transparent bg-clip-text" style="background-image: linear-gradient(135deg, #FBBF24 0%, #F59E0B 50%, #D97706 100%);">Bupati</span></h1>
                <p class="mt-6 text-sky-200 text-lg font-medium max-w-2xl mx-auto leading-relaxed">Surat Keputusan Bupati Mahakam Ulu terkait penetapan dan pelaksanaan kebijakan daerah.</p>
                <div class="mt-8 flex items-center justify-center gap-2 text-sm text-white/50"><a href="{{ route('beranda') }}" class="hover:text-yellow-400 transition-colors">Beranda</a><span>/</span><span>Regulasi</span><span>/</span><span class="text-yellow-400">SK Bupati</span></div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <main class="lg:col-span-3" data-aos="fade-up">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
                    <div>
                        <h2 class="text-2xl font-bold text-slate-900 flex items-center gap-3"><span class="w-10 h-10 bg-sky-100 rounded-xl flex items-center justify-center text-sky-600"><svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg></span>Daftar SK Bupati</h2>
                        <p class="text-slate-500 text-sm mt-1 ml-[52px]">Surat Keputusan Bupati Mahakam Ulu</p>
                    </div>
                ...
                @php
                $regulasiCategory = 'sk-bupati';
                $regulations = [
                    ['key' => 'reg_skb_45_2022', 'no' => 'SK Bupati No. 45 Tahun 2022', 'title' => 'Penetapan Tim Koordinasi Perencanaan Pembangunan Daerah', 'year' => '2022', 'status' => 'Berlaku'],
                    ['key' => 'reg_skb_102_2021', 'no' => 'SK Bupati No. 102 Tahun 2021', 'title' => 'Pembentukan Forum Perangkat Daerah Kabupaten Mahakam Ulu', 'year' => '2021', 'status' => 'Berlaku'],
                    ['key' => 'reg_skb_78_2023', 'no' => 'SK Bupati No. 78 Tahun 2023', 'title' => 'Penetapan Indikator Kinerja Utama Pemerintah Kabupaten Mahakam Ulu', 'year' => '2023', 'status' => 'Berlaku'],
                ]; @endphp
